...
allowed-tools: ["Bash(ls .claude/gaac-loop.local/*/state.md:*)", "Bash(rm .claude/gaac-loop.local/*/state.md)", "Bash(cat .claude/gaac-loop.local/*/state.md)", "Read"]
...
```bash
ls .claude/gaac-loop.local/*/state.md 2>/dev/null || echo "NO_LOOP"
```
...
3. **If state file(s) found**:
   ...
   - Remove the state file(s) using: `rm .claude/gaac-loop.local/*/state.md`
